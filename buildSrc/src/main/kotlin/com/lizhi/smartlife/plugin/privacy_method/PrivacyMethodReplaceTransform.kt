 ...
 * @Since 2020/10/12
 */
class PrivacyMethodReplaceTransform(private val project: Project) : Transform() {
    override fun getName(): String {
        return "PrivacyMethodReplaceTransform"
    }
    ...
    override fun transform(transformInvocation: TransformInvocation?) {
        ...
        val helper = PrivacyMethodReplaceAsmHelper()
        ...
        info("PrivacyMethodReplaceTransform const ${System.currentTimeMillis() - startTime}")
    }
}